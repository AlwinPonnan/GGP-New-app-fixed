    ...
    <View style={{backgroundColor: Colors.WHITE, flex: 1}}>
      <ImageBackground
        ...
        <View style={[styles.view]}>
          ...
          <TouchableOpacity
            onPress={() => {
              props.navigation.navigate('KidLogin');
            }}
            style={[styles.bg, {marginTop: Spacing.MARGIN_40}]}>
            <Text style={[styles.text, {color: Colors.WHITE}]}>Kid</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.bg1, {marginTop: Spacing.MARGIN_25}]}
            onPress={() => props.navigation.navigate('LoginParent')}>
