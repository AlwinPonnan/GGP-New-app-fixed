...
export default function Login(props) {
  ...
  const getUserData = async () => {
    ...
    try {
      ...
      console.log('User Data on Login API', res.data);
      if (res.data) {
          ...
          <>
            ...
            <LinearGradient
              ...
              <View style={{paddingVertical: Spacing.MARGIN_50}}>
                <Text style={[commonStyle.title, styles.title]}>
                  Welcome to Good Good Piggy
                </Text>
                <Text style={[styles.contain]}>
                  The next-gen digital piggy bank and habit builder to help
            ...
            <View style={{paddingHorizontal: Spacing.MARGIN_20}}>
              <LinearGradient
                ...
                style={[
                  styles.linearBtn,
                  {height: hp(6.5), marginTop: Spacing.MARGIN_50},
                ]}>
                <View
                  style={[
                    styles.btnView,
                    {borderRadius: 40, backgroundColor: Colors.WHITE},
                  ]}>
                  <TextInput
                    ...
                    maxLength={10}
                    style={{paddingHorizontal: Spacing.MARGIN_15}}
                  />
                </View>
              </LinearGradient>
              ...
              <View
                style={[
                  commonStyle.flexRow,
                  {alignSelf: 'center', marginTop: Spacing.MARGIN_15},
                ]}>
                <TouchableOpacity
                  onPress={() => getUserData()}
                ...
                <TouchableOpacity
                  style={{marginLeft: Spacing.MARGIN_20}}
