...
export default function LoginParent(props) {
    ...
    try {
      if (pin.length < 4) {
        ...
        if (tempFavcyTokenResponse.data) {
          ...
          console.log('User Login Data', res, 'res');
          track('User Login', {
            LoginAs: res.role,
          ...
          if (res.data) {
            let {data: validSubscriptionRes} = await getValidSubscription(
              res.data.userId,
            );
      ...
      if (error?.response?.data?.message) {
        if (
          error.response.data.message ==
          'Please Purchase a subscription to login!'
        ) {
          console.log('true');
        }
        setToggleModal(true);
  ...
  return (
    <View style={{backgroundColor: Colors.WHITE, flex: 1}}>
      <ImageBackground
        source={require('../images/shippingBg.png')}
          ...
          <>
            ...
            <View style={{paddingHorizontal: Spacing.MARGIN_25}}>
              ...
              <LinearGradient
                ...
                style={[styles.linearBtn, {height: hp(6.5)}]}>
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  style={{marginTop: Spacing.MARGIN_15}}>
                  <LinearGradient
                    start={{x: 1, y: 0}}
                    end={{x: 0, y: 2}}
                    colors={[
